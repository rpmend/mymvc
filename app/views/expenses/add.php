...
<form action="<?php echo URLROOT; ?>/expenses/add" method="post">
    ...
    <div>
        ...
        <input type="text" name="description" placeholder="internet provider" maxlength="45" required>
    </div>
    ...
    <div>
        ...
        <input type="text" name="category" placeholder="home bills" maxlength="45" required>
    </div>
    ...
    <div>
        ...
        <input type="number" name="amount" placeholder="127.50" min="0" max="99999999" step=".01" required>
    </div>
    ...
    <div>
        ...
        <input type="number" name="duedate" placeholder="20" min="1" max="31" step="1" required>
    </div>
